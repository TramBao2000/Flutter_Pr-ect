...
class Encrypter {
  ...
  /// Calls [encryptCustom] on the wrapped Algorithm.
  String encryptCustom(
      String data, {
        IV? iv,
        Uint8List? associatedData,
      }) {

    return algo.encryptCustom(
      data,
      iv: iv,
      associatedData: associatedData,
    );
  ...
  /// Calls [decryptCustom] on the wrapped Algorithm.
  String decryptCustom(
    ...
    return algo
        .decryptCustom(data, iv: iv, associatedData: associatedData);
  }
