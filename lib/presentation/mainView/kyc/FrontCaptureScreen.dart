...
class FrontCaptureWidget extends StatefulWidget {
  const FrontCaptureWidget({
    Key? key,
    this.titleScreen = "",
    this.noteTitle = "",
    this.typeCamera="",
  ...
  @override
  _FrontCaptureWidgetState createState() => _FrontCaptureWidgetState();
}

class _FrontCaptureWidgetState extends State<FrontCaptureWidget> {
  bool status = true;
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Quý khách vui lòng đưa mặt trước CMND vào khung hình, hệ thống sẽ thực hiện chụp tự động:",
              style: GoogleFonts.poppins(
                fontSize: 12,
                fontWeight: FontWeight.w400,
                  ...
                  child: InkResponse(
                    ...
                    onTap: () async {
                      ...
                      try {
                        ...
                        await moveToBacksideCaptureScreen(context);
                      } catch (e) {
            ...
            child: Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: () => moveToGuideVideoCaptureScreen(context),
                ),
              ],
            ),
          ),
